...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Sub-Categorias",$_SESSION['refroll_predio'],'');


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Sub-Categorias";

$plural = "Sub-Categorias";

$eliminar = "eliminarSubCategorias";

$insertar = "insertarSubCategorias";
...
$tabla 			= "tbsubcategorias";

$lblCambio	 	= array("esegreso","refcategorias");
$lblreemplazo	= array("Es Egreso","Categorias");
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerSubCategorias(),4);
