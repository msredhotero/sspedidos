    	...
    	<div class="cuerpoBox filt">
            ...
            <table class="table table-striped" id="table-6">
                ...
                <tbody class="detallefaltante">
                	<?php
						$total = 0;
						if (mysqli_num_rows($lstCargadosProductosFaltantes)>0) {
							while ($rowT = mysqli_fetch_array($lstCargadosProductosFaltantes)) {
								$total += 1;
					?>
                    		<tr>
    	...
    	<div class="cuerpoBox">
            ...
            <table class="table table-striped" id="table-6">
                ...
                <tbody class="detalle">
                	<?php
						$total = 0;
						if (mysqli_num_rows($pedidosTemporal)>0) {
							while ($rowT = mysqli_fetch_array($pedidosTemporal)) {
								$total += 1;
					?>
                    		<tr>
                    		...
                    		<td><?php echo $rowT['descripcion']; ?></td>
                            <td align="center"><?php echo $rowT['cantidad']; ?></td>
                    		<td class="text-center"><button type="button" class="btn btn-danger eliminarfila" id="<?php echo $rowT['iddetallepedido']; ?>" style="margin-left:0px;">Eliminar</button></td>
                    		</tr>
                    <?php
							}
						}
